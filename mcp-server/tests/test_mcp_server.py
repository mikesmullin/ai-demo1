...
from mcp_server.app import app, _inner_app
from mcp_server.tools import call_get_lat_lng, call_get_weather, execute_tool
...
def test_mcp_app_has_mcp_route():
    ...
    from mcp_server.app import _inner_app
